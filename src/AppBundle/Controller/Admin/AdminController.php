...
class AdminController extends Controller {
     ...
     */
    public function newteacherAction(Request $request, UserPasswordEncoderInterface $enncoder ) {  
        $teacher = new Teacher;
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $em = $this->getDoctrine()
                    ->getManager();
            $teacher->setPassword($enncoder->encodePassword($teacher, $teacher->getPassword()));
     ...
     */
    public function editteacherAction($id, Request $request) {                  
     ...
     */
    public function newstudentAction(Request $request, UserPasswordEncoderInterface $enncoder) {           
        $student = new Student;
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $em = $this->getDoctrine()
                    ->getManager();
            $student->setPassword($enncoder->encodePassword($student, $student->getPassword()));
     ...
     */
    public function editsubjecttAction($id, Request $request) {                 
     ...
     */
    public function editclassroomAction($id, Request $request) {                
     ...
     */
    public function newattendantAction(Request $request) {                      
    ...
    /**
     * Edit existing attendant
     * 
     * @Route("/admin/attendant/edit/{id}", name="admin_editattendant")   
     */
    public function editattendantAction($id, Request $request) {                
     ...
     */
    public function deleteattendantAction($id) {                                
